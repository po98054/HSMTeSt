...
public class UniversityDBVer01ByHSM {
	...
	public UniversityDBVer01ByHSM(String url, String id, String pw) throws Exception {
	...
	public void insertStudent(String st_num, String st_name, int st_semester, String st_state, String st_pr_num) throws Exception {
	...
	void removeStudent(String st_num) throws SQLException {
