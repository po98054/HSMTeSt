...
public class StudentManagerVer01ByTeacher {

	Connection con;
	
	static Scanner scan = new Scanner(System.in);
	
	static StudentDAOImpVer01ByTeacher studentDao;
	
	public static void main(String[] args) {
		
		StudentManagerVer01ByTeacher sm = new StudentManagerVer01ByTeacher();
        ...
        try {
			...
			studentDao = new StudentDAOImpVer01ByTeacher(sm.con);
	...
	private static void insertStudent() {
		...
		if(studentDao.insertStudent(new StudentVO1ByTeacher(st_num, st_name, st_semester, st_state, st_pr_num)))
	...
	private static void printStudentList() throws Exception {
		...
		List<StudentVO1ByTeacher> list = studentDao.selectAllStudent();
		...
		if(list.size()==0) {
			...
			for(StudentVO1ByTeacher tmp: list)
