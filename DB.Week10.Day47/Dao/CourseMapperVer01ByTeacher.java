...
public class CourseMapperVer01ByTeacher implements CourseDaoVer01ByTeacher{
	
	private DBConnectorVer01ByTeacher dbConnector;

	public CourseMapperVer01ByTeacher(DBConnectorVer01ByTeacher dbConnector) {
		
		this.dbConnector = dbConnector;
		
	}

	public void insertLecture(LectureVer01ByTeacher lecture) {
	...
	public void updateLecture(LectureVer01ByTeacher lecture) {
	...
	public LectureVer01ByTeacher selectLectureByName(String le_name, int le_class, int le_year, String le_term) {
		
		String sql = "select le_num, le_name, le_schedule, le_point, le_class, le_year, le_term, le_pr_num from lecture where le_name = ? and le_class = ? and le_year = ?"
				+ " and le_term = ?";
		...
		if(dbConnector.rs.next()) {
			...
			return new LectureVer01ByTeacher(le_num, le_name, le_schedule, le_point, le_class, le_year, le_term, le_pr_num);
	...
	public void insertCourse(CourseVoVer01ByTeacher course) {
		...
		dbConnector.pstmt.setString(1, course.getCo_st_num());
		
		dbConnector.pstmt.setInt(2, course.getCo_le_num());
		
		dbConnector.pstmt.setString(3, course.getCo_type());
		...
		public void deleteCourse(int le_num, String co_st_num) {
			...
			if(count == 0) {
				...
				System.out.println("수강 삭제 실패");
				
			} else {
				
				System.out.println("수강 삭제 성공");
