...
public class ScoreVer2 {
	...
	// 필드
		...
		public ScoreVer2(String sub, int dict, int middle, int fin, int perfor) {
		...
		public ScoreVer2(String sub, int dict) {
