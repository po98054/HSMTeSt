...
@Data
public class LectureVer01ByTeacher {
	...
	public LectureVer01ByTeacher(int le_num, String le_name, String le_schedule, int le_point, int le_class, int le_year, String le_term, String le_pr_num) {
