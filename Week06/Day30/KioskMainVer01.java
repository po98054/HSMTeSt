...
public class KioskMainVer01 {
	...
	private static ArrayList<KioskVer01> kioskList = new ArrayList<KioskVer01>();
	
	private static KioskVer01 kiosk;
	...
	public static void insertProduct() throws ParseException {
		...
		KioskVer01 kiosk = new KioskVer01(classification, productName, Quantity, saleDate);
	...
	public static void updateProduct() {
		...
		int index = kioskList.indexOf(new KioskVer01(classification, productName));
