...
public class AccountServiceImpVer03 implements AccountServiceVer03{
	
	@Override
	public ItemVer03 inputItem(Scanner sc) throws ParseException {
		...
		return new ItemVer03(type, purpose, content, money, date);
		
	}

	@Override
	public void insertItem(ArrayList<ItemVer03> list, ItemVer03 item) {
		
		// 리스트에 내역 추가 => 추가한 내역들을 날짜를 기준으로 정렬
		
		list.add(item);
		
		Collections.sort(list, new Comparator<ItemVer03>() {

			@Override
			public int compare(ItemVer03 o1, ItemVer03 o2) {
	...
	@Override
	public void printItem(ArrayList<ItemVer03> list) {
	...
	@Override
	public boolean updateItem(ArrayList<ItemVer03> list, int index, ItemVer03 item) {
	...
	@Override
	public boolean deleteItem(ArrayList<ItemVer03> list, int index) {
	...
	@Override
	public void runMenu(ArrayList<ItemVer03> list, int menu, Scanner sc) throws ParseException {
	...
	@Override
	public int selectItem(ArrayList<ItemVer03> list, Scanner sc, String date) {
	...
	@Override
	public void printItem(ArrayList<ItemVer03> list, int... dates) {
	...
	@Override
	public void runPrint(int subMenu, Scanner sc, ArrayList<ItemVer03> list) {
		...
		case 3 :
			...
			int year2 = inputYear(sc);
			
			int month = inputMonth(sc);
			
			printItem(list, (s) -> s.getDateStr().substring(0, 7).equals("" + year2 + "-" + month));
		...
		case 4 :
			...
			int year3 = inputYear(sc);
			
			int month2 = inputMonth(sc);
			
			int day = inputDay(sc);
			
			printItem(list, (s) -> s.getDateStr().substring(0, 10).equals("" + year3 + "-" + month2 + "-" + day));
	...
	@Override
	public void printItem(ArrayList<ItemVer03> list, Predicate<ItemVer03> p) {
		
		for(ItemVer03 temp : list) {
